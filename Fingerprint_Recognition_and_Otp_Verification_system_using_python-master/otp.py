...
class otp:
    ...
    def __init__(self, window):
        ...
        self.window.title("Final Step OTP Verification")
    ...
    def start(self):
        ...
        self.otp_label = Label(self.window, text="Enter Recent OTP ", font=("yu gothic ui", 13, "bold"))
            ...
            try:
                try:
                    ...
                    if "@" in self.email_entry.get():
                        ...
                        server.login("abhimanyuk1212@gmail.com", "uqozmbmbznxmccak")
                        self.e = str(self.email_entry.get())
                        server.sendmail("abhimanyuk1212@gmail.com", f"{self.e}", f"{self.value}")
                        ...
                        client.messages.create(to=(age1), from_="+12184383897", body=self.value)


                except BaseException as msg:
                    messagebox.showerror("Failed",
                                         "There is an error sending OTP\n Make sure you are connected to internet \n Verify number in TWILIO"
                                         )
